...
def simular_grupos():
    ...
    Grupos_json = {
        ...
        "E":sorted(grupos[4], key=lambda t: t.puntos , reverse=True),
...
def simular_octavos(): 
    ...
    print("lista cuartos",lista_Cuartos)
    return(Octavos_json)
def simular_cuartos():
    cruces = []
    print("Cuartos")   
...
grupos_front = simular_grupos()
octavos_front = simular_octavos()
...
print("Semis simuladas",Semis_front)
print("Final simulada",Final_front)